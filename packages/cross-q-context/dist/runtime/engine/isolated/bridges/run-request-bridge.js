 ...
 */
export function createRunRequestBridge(host) {
    ...
    const handler = async (descriptor) => {
        ...
        try {
            ...
            const descriptorForHost = descriptor;
            const envelope = await host.runRequest(descriptorForHost);
