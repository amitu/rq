 ...
 */
export declare function createBrowserFetchHandler(host: SendRequestHost): (req: FetchRequestData) => Promise<FetchResponseData>;
export declare function createBrowserFetchBridge(host: SendRequestHost): SafeBridge;
export {};
