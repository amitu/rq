...
export type InstallEvent = InstallEventResolving | InstallEventDownloading | InstallEventInstalled | InstallEventFailed | InstallEventAlreadyInstalled;
 ...
 */
export type InstallErrorCode = 'BLACKLISTED' | 'NOT_FOUND' | 'VERSION_NOT_FOUND' | 'NETWORK_ERROR' | 'NATIVE_ADDON' | 'INTEGRITY_FAILED' | 'INSTALL_FAILED' | 'TIMEOUT';
...
export type UninstallResult = {
    ...
    readonly errorCode: UninstallErrorCode;
    readonly message: string;
};
