...
export declare class SkipRequestSignal extends Error {
    readonly kind: "skip-request-signal";
    constructor();
}
 ...
 * settles.
 */
export declare function createExecutionNamespace(collector: ExecutionDirectiveCollector, phase: ScriptPhase, location: readonly string[], runRequestImpl?: RunRequestImpl): RqExecutionNamespace & {
    skipRequest?: () => never;
};
