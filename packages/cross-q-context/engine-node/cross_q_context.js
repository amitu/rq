...
function extract_requires(source) {
    ...
    try {
        ...
        const ret = wasm.extract_requires(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
exports.extract_requires = extract_requires;
...
const wasmPath = `${__dirname}/cross_q_context_bg.wasm`;
