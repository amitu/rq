...
const INSPECT_OPTIONS = { depth: 4, breakLength: 120 } as const;

export type UtilOp = { readonly json: string };
export type UtilResult = { readonly text: string };

export function browserUtilHandler(req: UtilOp): UtilResult {
  let value: unknown;
  try {
